...
tape( 'the command-line interface converts a string argument to Pascal case', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
		'"process.stdin.isTTY = true; process.argv[ 2 ] = \'HELLO_WORLD!\'; require( \''+fpath+'\' );"'
	];
